...
class dmRabaisPerCategory(models.Model):
    ...
    amount = models.DecimalField(
        ...
        null=True,
        help_text=
        _("Un montant fixe à retirer du prix original, laisser vide pour privilégier le pourcentage."
          ))
    percent = models.PositiveSmallIntegerField(
        ...
        null=True,
        help_text=
        _("Un pourcentage à retirer du prix original, ne sera pas utilisé s'il y a un montant dans 'Montant fixe'."
          ))
    ...
    valid_until = models.DateTimeField(verbose_name=_('Date de fin'),
                                       blank=True,
                                       null=True)
    categories = models.ManyToManyField("dshop.ProductCategory",
...
class dmPromoCode(models.Model):
    ...
    valid_from = models.DateTimeField(verbose_name=_("Start at"),
                                      default=datetime.now)
    valid_until = models.DateTimeField(
        ...
        null=True,
        help_text=
        _("Leave blank if you doesn't want this code to expire after a specific time."
          ))
    valid_uses = models.PositiveSmallIntegerField(
        ...
        null=False,
        help_text=
        _("Leave to 0 if you doesn't want this code to expire after a specific number of customer's uses."
          ))
...
class dmCustomerPromoCode(models.Model):
    ...
    customer = models.ForeignKey(Customer,
                                 ...
                                 blank=False,
                                 null=False)
    promocode = models.ForeignKey(dmPromoCode,
                                  on_delete=models.CASCADE,
                                  verbose_name=_("Promo Code"),
                                  blank=False,
                                  null=False)
