...
def forwards_func(apps, schema_editor):
    MyModel = apps.get_model('dmShipping', 'ShippingManagement')
    MyModelTranslation = apps.get_model('dmShipping', 'ShippingManagementTranslation')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dmShipping', '0013_shippingmanagementtranslation'),
    ]
