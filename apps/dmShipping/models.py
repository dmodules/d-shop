...
class ShippingManagement(models.Model):
    ...
    CHOICE_IDENTIFIER = [
        ("free-shipping", _("Postal shipping (free)")),
        ("standard-shipping", _("Postal shipping (standard)")),
        ("express-shipping", _("Postal shipping (express)")),
    ...
    use_separator = models.BooleanField(
        verbose_name=_("Use an amount to separate two price?"), default=True)
    separator = models.DecimalField(
        ...
        null=True,
        help_text=
        _("The amount of the cart price to separate the shipping price before and after it."
          ))
    price_after = models.DecimalField(
        ...
        null=True,
        help_text=
        _("The price to replace the original shipping price if the separator's amount has been reached."
          ))
