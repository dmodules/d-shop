...
class StripePayment(PaymentProvider):
  ...
  def get_payment_request(self, cart, request):
    ...
    try:
      ...
      site = SITE_URL
      success_url=site+"/billing-stripe/payment/?referenceId="+str(referenceId)
      cancel_url=site+"/billing-stripe/cancel/?referenceId="+str(referenceId)
      line_items = []
      ...
      redirect_url = '/billing-stripe/checkout/?referenceId='+str(referenceId)+'&session='+str(session['id'])
