# Generated by Django 2.2.17 on 2020-11-27 13:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, max_length=100, null=True, verbose_name='Titre')),
                ('subtitle', models.CharField(blank=True, max_length=200, null=True, verbose_name='Sous-titre')),
                ('title_color', colorfield.fields.ColorField(default='#ffffff', max_length=18, verbose_name='Couleur du titre')),
                ('title_shadow', colorfield.fields.ColorField(default='#45a5a0', max_length=18, verbose_name="Couleur d'ombre du titre")),
                ('subtitle_color', colorfield.fields.ColorField(default='#ffffff', max_length=18, verbose_name='Couleur du sous-titre')),
                ...
                ('bg_color', colorfield.fields.ColorField(default='#f7f6fa', max_length=18, verbose_name='Couleur de fond')),
                ('image', models.ImageField(blank=True, help_text="Dimension : 1920x961. Laisser vide pour ne pas afficher d'image.", null=True, upload_to='', verbose_name='Image')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='product',
            name='main_image',
            field=filer.fields.image.FilerImageField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='main_image', to=settings.FILER_IMAGE_MODEL, verbose_name='Image principale'),
        ),
        migrations.AddField(
            model_name='product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('storage', models.PositiveIntegerField(verbose_name='Internal Storage')),
                ('quantity', models.PositiveIntegerField(default=0, help_text='Available quantity in stock', validators=[django.core.validators.MinValueValidator(0)], verbose_name='Quantity')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'product default Translation',
